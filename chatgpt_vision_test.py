        ...
        'messages': [
            {
                ...
                'content': [
                    {
                        'type': 'text',
                        'text': 'Find all numbers in this image and return them each on a new line, unless the word "Set" is in the same line as the number. Do not return ANYTHING except the numbers.'
                    },
                    {
                        'type': 'image_url',
                        'image_url': {
